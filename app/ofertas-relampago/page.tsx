...
const PAGE_TITLE = "Ofertas Relâmpago";
const PAGE_DESCRIPTION =
  "Ofertas relâmpago aprovadas e ativas do Radar Smart — tempo limitado, substituídas automaticamente conforme expiram.";

export const metadata: Metadata = {
  title: PAGE_TITLE,
  description: PAGE_DESCRIPTION,
  alternates: {
    canonical: toAbsoluteSiteUrl("/ofertas-relampago"),
  },
  openGraph: {
    title: `${PAGE_TITLE} | Radar Smart`,
    description: PAGE_DESCRIPTION,
    url: toAbsoluteSiteUrl("/ofertas-relampago"),
    type: "website",
  },
  twitter: {
    card: "summary",
    ...
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 md:py-12">
        <section className="rounded-3xl border border-slate-200 bg-white px-6 py-8 shadow-sm md:px-8">
          <h1 className="font-display text-4xl font-black text-navy">Ofertas Relâmpago</h1>
          <p className="mt-3 text-sm text-rs-muted md:text-base">
            Tempo limitado — conforme uma oferta expira, ela sai da lista automaticamente e é
            substituída por outras aprovadas.
          </p>
          <div className="mt-8">
