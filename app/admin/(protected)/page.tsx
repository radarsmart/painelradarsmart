...
export default async function AdminDashboardPage() {
  ...
  const aprovadasHoje = (data ?? []) as ApprovedOfferTodayRow[];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-rs-muted">
          Visao operacional de cliques, fila e receita por marketplace.
        </p>
      </div>
